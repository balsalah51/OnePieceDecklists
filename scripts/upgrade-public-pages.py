        ...
        <section class="home-splash" id="home-splash" aria-label="One Piece Decklists banners" style="--splash-i:0">
          <div class="home-splash-viewport">
            <div class="home-splash-track">
              ...
              <img class="home-splash-bg" src="/img/home-banner-six.jpg" alt="One Piece Decklists with Luffy, Nico Robin, Rocks D. Xebec, Sabo, Charlotte Linlin, and Portgas D. Ace" width="1920" height="960" decoding="async" />
            </div>
          </div>
